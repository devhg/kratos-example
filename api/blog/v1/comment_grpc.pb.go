...
type CommentServiceClient interface {
	...
	ListArticleComment(ctx context.Context, in *ListCommentReq, opts ...grpc.CallOption) (*ListCommentReply, error)
}
...
func (c *commentServiceClient) CreateComment(ctx context.Context, in *CreateCommentRequest, opts ...grpc.CallOption) (*CreateCommentReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.blog.v1.CommentService/CreateComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentServiceClient) ListArticleComment(ctx context.Context, in *ListCommentReq, opts ...grpc.CallOption) (*ListCommentReply, error) {
	out := new(ListCommentReply)
	err := c.cc.Invoke(ctx, "/api.blog.v1.CommentService/ListArticleComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCommentServiceServer) ListArticleComment(context.Context, *ListCommentReq) (*ListCommentReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListArticleComment not implemented")
}
...
func _CommentService_CreateComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.blog.v1.CommentService/CreateComment",
	}
...
func _CommentService_ListArticleComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListCommentReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommentServiceServer).ListArticleComment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.blog.v1.CommentService/ListArticleComment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).ListArticleComment(ctx, req.(*ListCommentReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CommentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.blog.v1.CommentService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListArticleComment",
			Handler:    _CommentService_ListArticleComment_Handler,
		},
	},
